...
//        addWindowStateListener();
        ...
        frame.addComponentListener(new CaptureWindowListener());
        ...
        //Windows or JWindow instead of an undecorated JFrame.
        if (noDecorations) {
        ...
        //Show window.
        frame.setSize(new Dimension(160, 160));
    ...
    protected JComponent createOptionControls() {
        ...
        rb2.setText("Windows system decorated");
    ...
    protected static Image getFDImage() {
        java.net.URL imgURL = WindowDemo.class.getResource("images/FD.jpg");
        if (imgURL != null) {
            ...
            for (int i=0; i< 100; ++i) {
                for(int j=0; j<100; ++j) {
                    if(i == 0 || j == 0 || j == 99 || i == 99) {
                        bufferedImage.setRGB(i,j,black.getRed());
                    } else {
